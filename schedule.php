...
foreach ($schedule as $film) {
  ...
  <div class = "container schedule">
    <ul class = "schedule-row row">
      <li class = "col-sm-3">
          <a href = "movie.php?movie_id=<?php echo $film_id ?>">
          <img class = "schedule-row-img" src="<?php echo $film[7] ?>"> </a>
      </li>
      <li class = "col-sm-9">
        <h3 class = "film-title"><a href = "movie.php?movie_id=<?php echo $film_id ?>"><b><?php echo $film[5] ?></b></a></h3>
        ...
        <ul class="col-sm-4 film-seances">
          ...
          <li class= "film-seances-button">
            <button type="button" class="btn btn-primary btn-md js-request-movie" data-toggle="modal" data-schedule='<?php echo $schedule_id; ?>' data-price='<?php echo $price; ?>' data-target="#myModal">Buy ticket</button>
          </li>
        </ul>
      </div>
      </li>
